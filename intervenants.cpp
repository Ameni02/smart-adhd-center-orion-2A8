...
{
    QSqlQuery query;
    query.prepare("INSERT INTO INTERVENANTS (NOM,PRENOM,NUM,MDP,TYPE,ETAT,DOB,PHOTO) values (:nom , :prenom , :num, :mdp, :Type, :Etat, :dob, :photo)");
    query.bindValue(":nom",nom);
    query.bindValue(":prenom",prenom);
    query.bindValue(":num",num);
    query.bindValue(":mdp",mdp);
...
{
    QSqlQuery query;
    query.prepare("UPDATE INTERVENANTS SET NOM = :nom, PRENOM= :prenom,NUM = :num, TYPE= :Type,ETAT= :Etat, DOB= :dob, PHOTO = :photo WHERE IDIntervenant = :id");
...
{
    QSqlQuery query;
    query.prepare("UPDATE INTERVENANTS SET NOM = :nom, PRENOM= :prenom,NUM = :num, TYPE= :Type,ETAT= :Etat, DOB= :dob WHERE IDIntervenant = :id");
    query.bindValue(":id",idIntervenant);
    query.bindValue(":nom",nom);
    query.bindValue(":prenom",prenom);
    query.bindValue(":num",num);
